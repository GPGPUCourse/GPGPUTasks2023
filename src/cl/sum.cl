__kernel void sum_gpu_baseline(__global const unsigned int *arr,
...
__kernel void sum_gpu_cicle(__global const unsigned int *arr,
                        __global unsigned int *sum,
                        unsigned int n)
{
    const unsigned int gid = get_global_id(0);
...
__kernel void sum_gpu_cicle_coalesced(__global const unsigned int *arr,
                        __global unsigned int *sum,
                        unsigned int n)
{
...
__kernel void sum_gpu_local(__global const unsigned int* arr,
                        __global unsigned int* sum,
                        unsigned int n)
{
    const unsigned int gid = get_global_id(0);
