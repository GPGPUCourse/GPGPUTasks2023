...
int main() {
    ...
    for (int platformIndex = 0; platformIndex < platformsCount; ++platformIndex) {
        ...
        std::vector<unsigned char> vendor(platformNameSize, 0);
        OCL_SAFE_CALL(clGetPlatformInfo(platform, CL_PLATFORM_VENDOR, platformNameSize, vendor.data(), nullptr));
        std::cout << "    Vendores name: " << vendor.data() << std::endl;
        ...
        for (int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex) {
            ...
            std::cout << "    deviceNameSize: " << deviceNameSize << std::endl;
            ...
            std::cout << "    deviceMemorySize: " << deviceMemorySize / 1024. / 1024. << "Mbs" << std::endl;
