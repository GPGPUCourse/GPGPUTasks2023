...
int main() {
    ...
    for (int platformIndex = 0; platformIndex < platformsCount; ++platformIndex) {
        ...
        //  what():  OpenCL error code -30 encountered at /home/tulchin/GPUCalc/GPGPUTasks2023/src/main.cpp:55
        // Код соответсвует ошибке CL_INVALID_VALUE. Инфа из доки:
        ...
        for (int deviceIndex = 0; deviceIndex < devicesCount; ++deviceIndex) {
            ...
            cl_bool deviceEndian;
            OCL_SAFE_CALL(clGetDeviceInfo(device, CL_DEVICE_ENDIAN_LITTLE, sizeof(deviceEndian), &deviceEndian, nullptr));
            std::string deviceEndianStr;
            if (deviceEndian == CL_TRUE) {
                deviceEndianStr = "little";
            } else {
                deviceEndianStr = "big";
            }
            std::cout << "    Device endian: " << deviceEndianStr << std::endl;
