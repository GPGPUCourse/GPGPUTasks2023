...
int main(int argc, char **argv) {
    ...
    unsigned int global_work_size_x = gpu::divup(M, work_group_size) * work_group_size;
    unsigned int global_work_size_y = gpu::divup(K, work_group_size) * work_group_size;
