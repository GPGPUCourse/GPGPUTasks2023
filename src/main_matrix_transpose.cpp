...
int main(int argc, char **argv)
{
...

    {
        ...
        for (int iter = 0; iter < benchmarkingIters; ++iter) {
            ...
            unsigned int global_work_size_1 = (K + work_group_size - 1) / work_group_size * work_group_size;
            ...
            matrix_transpose_kernel.exec(gpu::WorkSize(work_group_size, work_group_size, global_work_size_1, global_work_size_0), as_gpu, as_t_gpu, M, K);
            t.nextLap();
        }
