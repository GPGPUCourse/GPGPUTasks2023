...
int main(int argc, char **argv)
{
    ...
    ocl::Kernel matrix_transpose_kernel(matrix_transpose, matrix_transpose_length, "matrix_transpose", "-DWG0=" + std::to_string(work_group_size) + " -DWG1=" + std::to_string(work_group_size*2));
...

    {
        ...
        for (int iter = 0; iter < benchmarkingIters; ++iter) {
            ...
            matrix_transpose_kernel.exec(gpu::WorkSize(work_group_size, work_group_size*2, K, M), as_gpu, as_t_gpu, K, M);
